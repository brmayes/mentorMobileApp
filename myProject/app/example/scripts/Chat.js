angular
  .module('example')
  .controller('Chat', function($scope, supersonic) {
    ...
    // 		$("#username").text("Greetings, " + currentUser.get("username") + ". What is your question?");
    //
    ...
    $(document).ready(function() {
    	Parse.initialize("MK8MnXgy7qDuaFDkLLMGiel34LefFFFgXSLmPFS9", "kX1mCmjilgnzKXUtFVC5cV1PNrLTdzh84EYA3Zzc");
    	currentUser = Parse.User.current();
